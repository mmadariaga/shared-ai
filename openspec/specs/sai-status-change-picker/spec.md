...
**Migration**: `sai/commands/sai-status.md` fetches `sai/policies/status-picker.md` instead of `change-picker.md`. The 0-change and 1-change resolution behavior is preserved verbatim by `status-picker.md`; see the `status-picker` capability.
