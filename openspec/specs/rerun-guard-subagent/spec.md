...
The `sai/commands/implement/instructions.md` Step 1b (re-run guard) MUST carry a directive instructing the executing agent to run that step in a dedicated subagent rather than inline in the main agent context.
...
- **WHEN** `sai/commands/implement/instructions.md` Step 1b is read
