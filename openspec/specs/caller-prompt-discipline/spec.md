# caller-prompt-discipline Specification

## Purpose

Constrains how callers author `budget-explorer` spawn prompts: every prompt states the goal and the output contract, and never prescribes a research tool, a procedure, or a method.
