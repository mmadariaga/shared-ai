...
- **THEN** it contains exactly one line: `Fetch @~/.config/opencode/sai/policies/remember.md`

### Requirement: opencode-sai-6-remember-fetch
`commands/opencode/sai-6-security.md` SHALL contain a `Fetch @~/.config/opencode/sai/policies/remember.md` line.
...
`commands/opencode/sai-7-performance.md` SHALL contain a `Fetch @~/.config/opencode/sai/policies/remember.md` line.
...
`commands/opencode/sai-8-accessibility.md` SHALL contain a `Fetch @~/.config/opencode/sai/policies/remember.md` line.
...
- **WHEN** `commands/opencode/sai-5-review.md` is read
- **THEN** `Fetch @~/.config/opencode/sai/policies/remember.md` is the last line, mirroring the position in `claude/commands/sai-5-review.md`

#### Scenario: position parity for sai-6
- **WHEN** `commands/opencode/sai-6-security.md` is read
- **THEN** `Fetch @~/.config/opencode/sai/policies/remember.md` is the last line
...
- **THEN** each still contains `Fetch @~/.config/opencode/sai/policies/remember.md`
