# Graceful Dependency Check Specification

## Purpose
Defines prerequisite validation performed by openspec-dependent `ai-*` commands so failures are caught early with actionable messages.
