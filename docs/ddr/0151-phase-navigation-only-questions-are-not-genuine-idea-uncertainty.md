# DDR 0151: Phase-navigation-only questions are not genuine idea uncertainty
...
- The disqualifier is independent of the crystallization-turn shared close (ADR 0158) and is applied as its own instruction step.
