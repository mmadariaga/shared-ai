# ADR 0118: Dedicated non-root service user with a validate-and-fail ownership contract
...
- `docs/adr/0117-orca-appimage-build-time-extraction.md` — the sibling decision on build-time extraction.
