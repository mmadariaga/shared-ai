# ADR 0150b: Supervised visible reports stay post-proceed (fetching-body order)

<!-- adr-index: refs 0147b; refs ddr:0150 -->
...
- ADR 0147b — supervised auto-execute next-action
