# ADR 0171c: Single-string invocation envelope across active SAI surfaces

<!-- adr-index: supersedes 0166; reframes 0159b; refs 0136; refs ddr:0114 -->
...
- `docs/adr/0159b-marker-grammar-stays-on-two-string-envelope.md` — reframed for one request string
