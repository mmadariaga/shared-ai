# ADR 0160: Apply Known-False Report Recovery branches by locus with five-part recovery content
...
- Plan defects may use the bounded repair route (ADR 0161) instead of burning worker slots.
...
- ADR 0161 — Bounded plan-artifact repair
- ADR 0159 — Three-slot distinct-diagnosis ledger
