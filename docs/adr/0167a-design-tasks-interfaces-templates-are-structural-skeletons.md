# ADR 0167a: Design/tasks/interfaces templates are structural skeletons

<!-- adr-index: pair-with 0166; refs 0162b -->
...
ADR 0166a makes the schema `instruction:` blocks authority pointers for the same three artifacts. ADR 0162b already reduced report/implementation schema templates to scaffolds with write-time authority pointers. This decision applies the heading-preserving skeleton pattern to the design-phase templates.
...
- Paired with ADR 0166a so instruction pointers and template skeletons land as one coherent single-source story.
