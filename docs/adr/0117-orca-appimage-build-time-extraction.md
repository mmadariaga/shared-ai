# ADR 0117: Orca AppImage is extracted at build time (no FUSE)
...
- `docs/adr/0118-orca-environment-nonroot-service-user.md` — the sibling decision on the runtime user and mount ownership.
