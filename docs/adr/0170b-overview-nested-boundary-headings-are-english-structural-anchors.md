# ADR 0170b: Overview nested boundary headings are English structural anchors

<!-- adr-index: refs ddr:0124b -->
...
- Complements DDR 0124b's projection-only localization rule with an explicit nested-heading membership.
