# ADR 0169b: Idea-list treats Diagnosis Round as recovery, not review

<!-- adr-index: refs 0116; refs 0137b; refs 0168b -->
...
- ADR 0137b — Non-worker idea-list glue at harness adapter seam
