# Implement invocation (inline caller)

Used by the preserved Copilot inline path and by the `/sai-2-design` continue-now path.

## Invoke planning
Fetch @sai/instructions/implement-invocation-core.md and follow it exactly.
