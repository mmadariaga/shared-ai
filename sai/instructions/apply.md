...
11. Either way → back to 1 with the next unchecked Step. Only when no unchecked Step remains: run the Final sweep, then declare the implementation done