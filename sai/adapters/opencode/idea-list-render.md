...
Fetch @sai/adapters/opencode/panel-render.md and use it for the harness panel mechanics. This binding supplies the `sai-explore` idea progress list's surface policy (item 11 of `sai/commands/explore/instructions.md`):
