...
Execute assigns verdicts and holds them in invocation memory; it prints nothing at this moment (E1, E9). Execute does not re-run Automated checks, write files, dispatch a worker, or create an extra commit (E2).
