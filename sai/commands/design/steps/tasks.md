...
Reference the active `openspec/specs/tasks-routing-metadata/spec.md` (the enum and derivation sources) and `openspec/specs/tasks-scaffold-format/spec.md` (the step-structure and position contract).
