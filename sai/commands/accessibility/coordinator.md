<TASK>
  ...
  Declare the step machine that governs step routing: `step_machine: accessibility-standalone@1`. See `@sai/policies/stage-machine.md` § Step machines for the operational contract.
