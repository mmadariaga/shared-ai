...
const twelveEntries = fifteenEntries;
...
test('defineWorkerMatrix returns the frozen matrix with the eleven canonical phases and the two apply roles', () => {
