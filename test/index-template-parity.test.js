...
// sai/commands/implement/adr-index.template.md and the DDR index template
// under sai/commands/implement/ddr-index.template.md are project-agnostic section
...
test('adr-index and ddr-index template parity', () => {
  const adr = readUtf8('sai/commands/implement/adr-index.template.md');
  const ddr = readUtf8('sai/commands/implement/ddr-index.template.md');
