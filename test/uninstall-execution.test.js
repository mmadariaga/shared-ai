...
test('matrix retirement: the active worker inventory stays exactly fifteen bindings and fifteen agents per harness', () => {
  ...
  const directBuildBindings = ['direct-build-worker.md', 'review-fix-worker.md'];
  const workers = [
