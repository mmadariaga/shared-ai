...
test('security bindings render the plan coordinator-only with threshold reference and no stamp', () => {
  const claude = artifact('sai/orchestration/workers/bindings/claude/security-worker.md');
  const opencode = artifact('sai/orchestration/workers/bindings/opencode/security-worker.md');
